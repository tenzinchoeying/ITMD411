...
public class Dao {
	...
	public static Connection getConnection() {
		try {
			conn = DriverManager.getConnection("jdbc:mysql://www.papademas.net/tickets?autoReconnect=true&useSSL=false" + "&user=fp411&password=411");
	...
	public void addUsers() {
		...
		try {
			...
			try {
				...
				statement = new Dao().getConnection().createStatement();
		...
		public void updateTicketById(int id, String issuer, String desc) {
			try {
				PreparedStatement ps = conn.prepareStatement("UPDATE " + name
